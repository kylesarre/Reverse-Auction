...
public class ProfileController implements Initializable
{
    ...
    public void setApp(Main application)
    {
        ...
        companyTypeLabel.setText("Company Type: " + loggedUser.getType());
        if(!loggedUser.getProfile().equals(""))				//If profile is not empty, replace label text with profile text
    ...
    /**
     * Changes visible profile elements for viewing profile and for editing profile
     * @param state true to edit profile, false to view profile
